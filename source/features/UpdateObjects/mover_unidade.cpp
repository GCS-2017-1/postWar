				   ...
				   int lastdt)
{
	...
	hexagonos[hexagon_selected->i_before][hexagon_selected->j_before]->contains_unit = 0;
	...
	hexagonos[hexagon_selected->i][hexagon_selected->j]->unit = temp;
	hexagonos[hexagon_selected->i][hexagon_selected->j]->contains_unit = 1;
}
